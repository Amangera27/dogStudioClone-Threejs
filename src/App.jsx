       ...
       <div className="images">
        ...
        <section id="section-1">
          <nav>
            ...
            <div className="nav-elem"> <i style={{color : "red"}} className="ri-arrow-right-s-line"></i> Our Show Reel </div>
            <div className="nav-elem">
              <i style={{fontSize: "30px"}} className="ri-menu-3-line"></i>
            </div>
          </nav>
          ...
          <div className='text-divider'>
            ...
            <div className="text-para">
               <h4>DogStudio is a multidisciplinary creative studio at the interaction of art,design and technology</h4>
               <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima voluptate suscipit iusto atque rerum fugit earum similique itaque distinctio, iste neque at consectetur, officia repellendus</p>
          </div>
          </div>
        ...
        <section id="section-3">
          <div className="top">
            <div className="left">
              <h3>Lorem ipsum dolor sit amet, consectetur <br /> adipisicing elit. Officia iste dolor quam <br /> accusamus sint illo, nobis consectetur br recusandae architecto doloribus!</h3>
            </div>
        ...
        <section id="section-4">
          <div className="bottom">
            ...
            <div className="right">
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem temporibus nihil atque maxime repellendus eos eveniet dolore adipisci explicabo laboriosam autem deleniti nam delectus reprehenderit blanditiis iste debitis, vel aliquid similique? Voluptas dolores magni soluta sed dolore, dignissimos ducimus error nihil temporibus, quod debitis. Molestias corrupti maiores dolorem nobis hic. </p>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem temporibus nihil atque maxime repellendus eos eveniet dolore adipisci explicabo laboriosam autem deleniti nam delectus reprehenderit blanditiis iste debitis, vel aliquid similique? Voluptas dolores magni soluta sed dolore, dignissimos ducimus error nihil temporibus, quod debitis. Molestias corrupti maiores dolorem nobis hic. </p>
            </div>
          </div>
        </section>
